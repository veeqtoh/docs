...
<Warning>
You must publish and run the migrations before enabling tracking. See [Installation — Publishing migrations](/getting-started/installation#publishing-migrations).
</Warning>
